 ...
 * A ProtocolParserListener can be registered as a listener to a ProtocolParser. The parser
 * then calls the eventHandlers.
 */
public interface ProtocolParserListener {
	/**
	 * Gets called when a parser receives a lecture query message.
	 * @param protocolParser the parser that parsed the message
	...
	public void onLectureList(ProtocolParser protocolParser, ParserCaller parserCaller,
			int lectureCount, int[] lectureIds, String[] lectureNames);
	/**
	 ...
	 */
	public void onNewLecture(ProtocolParser protocolParser, ParserCaller parserCaller,
	 ...
	 * @param predictedValues the user's predictions for the parameters
	 */
