 ...
 * The predict view presents a mask for entering predictions. It creates a TextEdit for 
 * every parameter of the current assignment. Users can lock their prediction which 
 * signals that the user is done predicting. As soon as a result is posted the ViewResult
 * view is started. 
 */
public class Predict extends AbstractPredictActivity {
	/**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.layout = new PredictList(this, controller.getUser(), this.controller.getCurrentMethod());
        ...
        this.showTextToastOnUi(this, R.string.newassignment);
    }
	...
	/**
	 * Locks all the predictions and hands the predicted values in to the server.
	 */
