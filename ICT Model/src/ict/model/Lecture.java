...
/**
 * A Lecture object represents all the important data of a lecture in the ICT-system. 
 * It is used to store identifying information and the state of the lecture.
...
public class Lecture {
	...
	/**
	 * A password for all basic clients that should not be able to hand out assignments.
	 */
	...
	/**
	 * Adds a user to the lecture's user list. Does not do anything if the user is already in the list.
