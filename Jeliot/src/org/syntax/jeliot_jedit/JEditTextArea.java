 ...
 *
 * @author Slava Pestov
 * @version $Id: JEditTextArea.java,v 1.4 2006/03/01 04:23:04 jeliot Exp $
 */
public class JEditTextArea extends JComponent {
    ...
    public void updateScrollBars() {
        ...
        if (horizontal != null && width != 0) {
            horizontal
                    .setValues(-horizontalOffset, width, -horizontalOffsetForScrollBar, width * 5);
        ...
        try {
            if (rectSelect) {
                ...
                if (selectedText != null && currNewline != selectedText.length()) {
                    ...
                    document
                            .insertString(offset + 1, selectedText.substring(currNewline + 1), null);
                }
            } else {
    ...
    class ScrollLayout implements LayoutManager {
        ...
        public Dimension preferredLayoutSize(Container parent) {
            ...
            if (border == null)
                ...
                insets = getBorder().getBorderInsets(JEditTextArea.this);
            }
        ...
        public void layoutContainer(Container parent) {
            ...
            right.setBounds(ileft + leftWidth + centerWidth, itop + topHeight, rightWidth,
                    centerHeight);

            bottom.setBounds(ileft, itop + topHeight + centerHeight,
            ...
            Math.max(0, size.width - vertical.getWidth() - ileft - iright), bottomHeight);
            if (top != null) {
                top.setBounds(ileft, itop, leftWidth + centerWidth + rightWidth, topHeight);
            }
        } //}}}
    ...
    //Added for Jeliot 3
    public void addToLeft(JComponent c) {
        add(LEFT, c);
        revalidate();
    }

    //Added for Jeliot 3
    public void addAdjustListernerForVertical(AdjustmentListener al) {
        vertical.addAdjustmentListener(al);
    }
    ...
    //Added for Jeliot 3
    public boolean isScrollBarsInitialized() {
    ...
    public Rectangle getTotalArea() {
        ...
        int maxLineLength = 0;
        int maxLineLenghtIndex = 0;
        for (int i = 0; i < lines; i++) {
            int lineLength = getLineLength(i);
            if (lineLength > maxLineLength) {
                maxLineLength = lineLength;
                maxLineLenghtIndex = i;
            }
        }
        String maxLengthString = getLine(maxLineLenghtIndex);
        maxLineLength = (int) getFontMetrics(getFont()).getStringBounds(maxLengthString, 0, maxLengthString.length(), getGraphics()).getWidth();
        area.setSize(maxLineLength, lines * getFontMetrics(getFont()).getHeight());
        return area;
    }
    ...
    public String getLine(int line) {
        try {
            ...
            if (lineElement == null)
                ...
                return document.getText(lineElement.getStartOffset(), lineElement.getEndOffset()
